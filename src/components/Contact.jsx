...
const inputStyle = {
  ...
  color: 'var(--black)', fontFamily: 'var(--sans)', fontSize: '13px',
...
export default function Contact() {
  ...
  if (sent) return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: .5 }}
      style={{ background: 'transparent', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: '24px', padding: '48px' }}>
      ...
      <h2 style={{ fontFamily: 'var(--serif)', fontSize: '36px', fontWeight: 300, color: 'var(--black)', textAlign: 'center' }}>Message envoyé</h2>
      <p style={{ fontFamily: 'var(--sans)', fontSize: '13px', color: 'rgba(34,35,37,.4)', textAlign: 'center', maxWidth: '400px', lineHeight: 1.7 }}>
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: .5 }}
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 48px' }}>
        ...
        <div style={{ marginBottom: '48px' }}>
          ...
          <h1 style={{ fontFamily: 'var(--serif)', fontSize: 'clamp(32px,4vw,52px)', fontWeight: 300, color: 'var(--black)', marginBottom: '12px' }}>Nous contacter</h1>
          <p style={{ fontFamily: 'var(--sans)', fontSize: '13px', color: 'rgba(34,35,37,.4)', lineHeight: 1.7 }}>
            Intéressé par un partenariat exclusif ? Renseignez vos coordonnées et nous vous rappelons sous 48h ouvrées.
          </p>
        </div>

        {/* Bannière visite */}
        <div style={{ marginBottom: '40px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1px', background: 'rgba(221,43,33,.15)' }}>
          <div style={{ background: 'rgba(221,43,33,.06)', padding: '36px 32px' }}>
            ...
            <h2 style={{ fontFamily: 'var(--serif)', fontSize: '26px', fontWeight: 300, color: 'var(--black)', marginBottom: '14px', lineHeight: 1.2 }}>
              Venez à nos locaux
            </h2>
            <p style={{ fontFamily: 'var(--sans)', fontSize: '13px', color: 'rgba(34,35,37,.5)', lineHeight: 1.75, marginBottom: '20px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {['Tarifs négociables en direct', 'Enlèvement immédiat possible', 'Obtention des formats premium', 'Dégustation avant achat'].map(item => (
                <div key={item} style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <span style={{ fontFamily: 'var(--sans)', fontSize: '12px', color: 'rgba(34,35,37,.65)' }}>{item}</span>
                </div>
              ))}
            </div>
          </div>
          <div style={{ background: 'rgba(34,35,37,.04)', padding: '36px 32px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <div style={{ fontFamily: 'var(--sans)', fontSize: '9px', letterSpacing: '.28em', textTransform: 'uppercase', color: 'rgba(34,35,37,.3)', marginBottom: '14px' }}>Nos coordonnées</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                {[
                  ...
                  <div key={l}>
                    <div style={{ fontFamily: 'var(--sans)', fontSize: '9px', letterSpacing: '.15em', textTransform: 'uppercase', color: 'rgba(34,35,37,.25)', marginBottom: '3px' }}>{l}</div>
                    <div style={{ fontFamily: 'var(--sans)', fontSize: '13px', color: 'rgba(34,35,37,.65)', lineHeight: 1.55, whiteSpace: 'pre-line' }}>{v}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div style={{ fontFamily: 'var(--sans)', fontSize: '10px', letterSpacing: '.2em', textTransform: 'uppercase', color: 'rgba(34,35,37,.25)', marginBottom: '24px', textAlign: 'center' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px', maxWidth: '680px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            <div>
              <label style={{ display: 'block', fontFamily: 'var(--sans)', fontSize: '9px', letterSpacing: '.2em', textTransform: 'uppercase', color: 'rgba(34,35,37,.35)', marginBottom: '8px' }}>Nom *</label>
            ...
            <div>
              <label style={{ display: 'block', fontFamily: 'var(--sans)', fontSize: '9px', letterSpacing: '.2em', textTransform: 'uppercase', color: 'rgba(34,35,37,.35)', marginBottom: '8px' }}>Entreprise</label>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            <div>
              <label style={{ display: 'block', fontFamily: 'var(--sans)', fontSize: '9px', letterSpacing: '.2em', textTransform: 'uppercase', color: 'rgba(34,35,37,.35)', marginBottom: '8px' }}>Email *</label>
            ...
            <div>
              <label style={{ display: 'block', fontFamily: 'var(--sans)', fontSize: '9px', letterSpacing: '.2em', textTransform: 'uppercase', color: 'rgba(34,35,37,.35)', marginBottom: '8px' }}>Téléphone</label>
          ...
          <div>
            <label style={{ display: 'block', fontFamily: 'var(--sans)', fontSize: '9px', letterSpacing: '.2em', textTransform: 'uppercase', color: 'rgba(34,35,37,.35)', marginBottom: '8px' }}>Message *</label>
          ...
          <button type="submit" disabled={!valid} style={{ alignSelf: 'flex-start', padding: '16px 48px', background: valid ? 'var(--gold)' : 'rgba(34,35,37,.09)', color: valid ? 'var(--black)' : 'rgba(34,35,37,.2)', border: '1px solid ' + (valid ? 'var(--gold)' : 'transparent'), fontFamily: 'var(--sans)', fontSize: '10px', fontWeight: 500, letterSpacing: '.18em', textTransform: 'uppercase', cursor: valid ? 'pointer' : 'default', transition: 'all .3s' }}
